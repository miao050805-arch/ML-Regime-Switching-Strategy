...
* **Noise Reduction**: Implemented a **5-day signal smoothing filter** to minimize over-trading and slippage costs. This optimization improved the Sharpe Ratio from **0.61 to 1.102**.
